...
public class ContactImpl extends ContactElementImpl implements Contact {
    ...
    public static final Pattern CONTACT_LETTER = Pattern.compile("[^a-zA-Z]*([a-zA-Z]).*");


    public final static int CONTACT_COLORS_MATERIAL[] = {
            0xffF44336,
            0xffE91E63,
            0xff9C27B0,
            0xff673AB7,
...
//       int phoneNo =cursor.getInt(cursor.getColumnIndex(ContactsContract.CommonDataKinds.Phone.NUMBER));
    ...
    public ContactImpl(long id, String lookupKey, String displayName, String firstName, String lastName, Uri photoUri) {
